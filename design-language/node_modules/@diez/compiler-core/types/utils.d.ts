 ...
 * @ignore
 */
export declare const printWarnings: (targetComponents: NamedComponentMap) => void;
/**
 ...
 * @ignore
 */
export declare const inferProjectName: (projectRoot: string) => string;
/**
 * Infers package version from the project root.
 * @internal
 * @ignore
 */
export declare const inferProjectVersion: (projectRoot: string) => string;
/**
 ...
 */
export declare class ExistingHotUrlMutexError extends Error {
    mutexPath: string;
 ...
 */
export declare const showStackTracesFromRuntimeError: (error: Error) => Promise<void>;
