 ...
 */
export declare const isChildProcess: (proc: void | Buffer | ChildProcess) => proc is ChildProcess;
/**
 * Encodes a package name to be safely transmitted via HTTP requests.
 */
export declare const encodePackageName: (name: string) => string;
/**
 * Decodes a package name transmitted via HTTP requests.
 */
export declare const decodePackageName: (name: string) => string;
/**
 * Page an input source using sensible pager applications per-platform.
 */
export declare const pager: (options: PagerOptions) => Promise<{
    code: number | null;
    signal: string | null;
}>;
