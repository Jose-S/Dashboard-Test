...
var TextField = function (_a) {
    ...
    return (react_1.default.createElement(Typography_1.default, __assign({ component: "span", variant: "body2", className: className }, sanitizeRestProps_1.default(rest)), value && typeof value !== 'string' ? JSON.stringify(value) : value));
};
