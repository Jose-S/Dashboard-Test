...
var RichTextField = function (_a) {
    ...
    if (stripTags) {
        return (React.createElement(Typography, __assign({ className: className, variant: "body2", component: "span" }, sanitizeRestProps(rest)), removeTags(value)));
    }
    return (React.createElement(Typography, __assign({ className: className, variant: "body2", component: "span" }, sanitizeRestProps(rest)),
