...
var useListParams = function (_a) {
    ...
    var _e = react_1.useState({}), displayedFilters = _e[0], setDisplayedFilters = _e[1];
    ...
    var changeParams = react_1.useCallback(function (action) {
        ...
        history.push({
            search: "?" + query_string_1.stringify(__assign(__assign({}, newParams), { filter: JSON.stringify(newParams.filter) })),
        });
    ...
    var debouncedSetFilters = debounce_1.default(function (newFilters) {
        return changeParams({
            type: queryReducer_1.SET_FILTER,
            payload: removeEmpty_1.default(newFilters),
        });
    }, debounce);
    var setFilters = react_1.useCallback(function (filters) { return debouncedSetFilters(filters); }, requestSignature // eslint-disable-line react-hooks/exhaustive-deps
    );
    ...
    var showFilter = react_1.useCallback(function (filterName, defaultValue) {
        ...
        if (typeof defaultValue !== 'undefined') {
            setFilters(set_1.default(filterValues, filterName, defaultValue));
        }
    }, requestSignature); // eslint-disable-line react-hooks/exhaustive-deps
    return [
...
exports.validQueryParams = ['page', 'perPage', 'sort', 'order', 'filter'];
